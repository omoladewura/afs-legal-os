...
function roleSystemPrompt(c: Case): string {
  ...
  const MAP: Record<string, string> = {
    ...
    petitioner_side: 'You are a Nigerian matrimonial causes cross-examination specialist acting for the Petitioner. Your goal is to establish the s.15(2) dissolution fact(s) through the Respondent\'s own testimony, expose condonation or connivance where raised as a defence, and undermine any cross-petition. The sole ground is irretrievable breakdown (s.15(1) MCA); the s.15(2) facts are your evidentiary tools. Apply the MCA, MCR, and Evidence Act 2011.',
    respondent_side: 'You are a Nigerian matrimonial causes cross-examination specialist acting for the Respondent. Your goal is to challenge the Petitioner\'s evidence of the alleged s.15(2) dissolution fact(s), establish available bars — condonation (ss.26–27 MCA), connivance, unreasonable delay (s.28 MCA) — and support any cross-petition. Apply the MCA, MCR, and Evidence Act 2011.',
  };
