...
function RunBtn({
  ...
  return (
    <button
      ...
      style={{
        background:    disabled || loading
          ? '#101018'
          : `linear-gradient(135deg, ${T.text}, #a07820)`,
    ...
    >
      {loading
        ? <><Spinner size={10} color={T.text} /> Processing…</>
        : label}
    </button>
  );
}
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            ...
            <button
              ...
              style={{
                ...
                border:        `1px solid ${saved ? T.bdr : T.text + '55'}`,
                color:         saved ? '#60b040' : T.text,
                borderRadius:  4,
                padding:       '5px 14px',
                fontSize:      10,
                fontFamily:    "'Times New Roman', Times, serif",
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {item.note && (
                <p style={{ fontSize: 11, color: T.mute, fontFamily: "'Times New Roman', Times, serif", fontStyle: 'italic' }}>
                  {item.note}
                </p>
              )}
              <p style={{ fontSize: 9, color: T.mute, fontFamily: "'Times New Roman', Times, serif", marginTop: 3 }}>
            ...
            <button
              ...
              onMouseLeave={e => (e.currentTarget.style.color = T.bdr)}
            >
              ✕
            </button>
          </div>
        ...
        {SUB_TABS.map(t => (
          <button
            ...
            style={{
              ...
              border:        `1px solid ${sub === t.id ? T.text : 'transparent'}`,
              color:         sub === t.id ? T.text : T.mute,
              borderRadius:  5,
              padding:       '8px 12px',
              fontSize:      10,
              fontFamily:    "'Times New Roman', Times, serif",
