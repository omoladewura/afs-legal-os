...
const APP_TYPES: AppTypeConfig[] = [
  ...
  { id: 'civil_injunction', label: 'Injunction', icon: '🚫', track: 'civil',
    package: ['Motion on Notice', 'Supporting Affidavit', 'Written Address in Support', 'Undertaking as to Damages', 'List of Authorities'],
    hint: 'Interlocutory, mandatory, or Mareva injunction — establish the three conditions: serious question, balance of convenience, adequacy of damages.' },
