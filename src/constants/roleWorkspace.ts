 ...
 *   authority, research, synthesis → written_address (deduplicated)
 *   criminal, san, filings, alerts → removed / absorbed
 * ROLE_TABS, ROLE_QUICK_ACTIONS, and ROLE_MODULES all updated.
 */
 ...
 * 'case_command' is always first. 'copilot' is always available.
 *
 ...
 *   risk, timeline, compliance → case_command (deduplicated)
 *   authority, research, synthesis → written_address (deduplicated)
 *   filings, san → removed (no longer top-level tabs)
 */
...
export const ROLE_QUICK_ACTIONS: Record<CounselRole, QuickAction[]> = {
  ...
  prosecution: [
    ...
    { label: 'Build Address',        icon: '✍', tab: 'written_address',    accent: '#c09030', hint: 'Opening / Sentencing address' },
  ],
  defence: [
    ...
    { label: 'Bail Application',     icon: '🔓', tab: 'case_command',       accent: '#40a860', hint: 'Draft or track bail' },
  ],
  petitioner_side: [
  ...
  frep_applicant: [
    ...
    { label: 'Written Address',   icon: '✍', tab: 'written_address', accent: '#1a5a38', hint: 'Written Address and Reply on Points of Law' },
    { label: 'Risk Analytics',    icon: '■',  tab: 'case_command',    accent: '#1a5a38', hint: 'Jurisdiction, laches, proper respondent, mode exposure' },
  ],
  frep_respondent: [
    ...
    { label: 'Written Address',   icon: '✍', tab: 'written_address', accent: '#7a3010', hint: 'Written Address in Opposition — 5-day window from service' },
    { label: 'Risk Analytics',    icon: '■',  tab: 'case_command',    accent: '#7a3010', hint: 'Admission risk, PO grounds, compliance exposure' },
  ],
};
...
export const ROLE_MODULES: Record<CounselRole, RoleModule[]> = {
  claimant_side: [
    ...
    { id: 'case_command',    icon: '■',  label: 'Risk Analytics',  desc: 'Limitation, default, enforcement risks' },
  ...
  defendant_side: [
    ...
    { id: 'case_command',    icon: '■',  label: 'Risk Analytics',  desc: 'Default exposure, appeal grounds' },
    { id: 'appeal',          icon: '↑',  label: 'Appeal Engine',   desc: 'Appellant\'s or Respondent\'s brief' },
  ],
  prosecution: [
    ...
    { id: 'written_address',  icon: '✍',  label: 'Written Address',  desc: 'Opening address, sentencing submissions' },
    { id: 'crossexam',        icon: '⚔',  label: 'Cross-Exam',       desc: 'Cross of defence witnesses' },
    { id: 'case_command',     icon: '⚙',  label: 'Compliance',       desc: 'ACJA compliance status' },
  ...
  defence: [
    ...
    { id: 'written_address',  icon: '✍',  label: 'Written Address',  desc: 'Defence address, allocutus' },
    { id: 'crossexam',        icon: '⚔',  label: 'Cross-Exam',       desc: 'Cross of prosecution witnesses' },
    { id: 'case_command',     icon: '⚖',  label: 'Case Command',     desc: 'Charge analysis, bail tracking, compliance' },
  ...
  petitioner_side: [
    ...
    { id: 'matrimonial',        icon: '⚖',  label: 'Matrimonial Engine', desc: 'Custody, maintenance, property — ancillary relief sub-tabs' },
