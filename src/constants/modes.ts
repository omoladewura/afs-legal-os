...
export const MODES: Mode[] = [
  ...
  // ── Communication ──────────────────────────────────────────────────────────
  { id: 'billions_voice',     icon: '✦',  label: 'Billions Voice',                sub: 'Rhetoric & Letter Writing',     desc: 'Write any letter, speech, or message with historical rhetoric woven in. Demand letters, client correspondence, confrontations — elevated to the level they deserve.', accent: '#7a1f2e', group: 'communication', type: 'tool' },
  // ── Smart Tools ────────────────────────────────────────────────────────────
...
export const MODE_GROUPS: ModeGroup[] = [
  ...
  { id: 'communication',  label: 'Communication & Rhetoric',         color: '#7a1f2e' },
