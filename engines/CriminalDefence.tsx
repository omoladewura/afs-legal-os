  ...
  return (
    <div style={{ background: '#060610', border: '1px solid #1e2e1e', borderRadius: 8, padding: '20px 22px', marginTop: 4 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 11, color: '#508050', fontFamily: 'Inter, sans-serif', letterSpacing: '.12em', textTransform: 'uppercase', fontWeight: 600 }}>
          {title}
        </span>
      ...
      <div>
        <div style={cardS}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr auto', gap: 10, alignItems: 'end', marginBottom: 16 }}>
            ...
            <button onClick={addEvidence} style={{ background: '#111120', border: '1px solid #2a2a3e', color: T.gold, borderRadius: 5, padding: '11px 18px', fontSize: 13, fontFamily: 'Inter, sans-serif', cursor: 'pointer', whiteSpace: 'nowrap' }}>
              + Add
            </button>
          </div>
            ...
            <div style={{ marginBottom: 16 }}>
              {evidenceList.map(e => (
                <div key={e.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '9px 14px', background: '#060610', border: '1px solid #111120', borderRadius: 5, marginBottom: 7 }}>
                  <span style={{ fontSize: 10, color: T.gold, fontFamily: 'Inter, sans-serif', border: '1px solid #3a2208', padding: '2px 8px', borderRadius: 2, letterSpacing: '.06em', whiteSpace: 'nowrap' }}>{e.type}</span>
                  <span style={{ fontSize: 14, color: '#c0bcb0', fontFamily: "'Cormorant Garamond', serif", flex: 1 }}>{e.desc}</span>
                  <button onClick={() => removeEvidence(e.id)} style={{ background: 'none', border: 'none', color: '#404050', cursor: 'pointer', fontSize: 16, padding: 0 }}>×</button>
                </div>
              ))}
            </div>
          )}
  ...
  return (
    <div style={{ padding: '24px 0', animation: 'fadeUp .3s ease' }}>
      ...
      <div style={{ marginBottom: 22 }}>
        ...
        <p style={{ fontSize: 14, color: '#505060', fontFamily: 'Inter, sans-serif', lineHeight: 1.6, marginTop: 6, maxWidth: 700 }}>
